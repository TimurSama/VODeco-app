...
import { corporatePartners } from '../../data/partners/corporatePartners';

export default function CorporatePage() {
  const [selectedPartner, setSelectedPartner] = useState<Partner | null>(null);
  const [searchQuery, setSearchQuery] = useState('');

  const filteredPartners = corporatePartners.filter(partner =>
    ...
    <div className="min-h-screen py-8 px-4 space-y-8">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <p className="text-gray-400 text-center max-w-2xl mx-auto">
          Ведущие компании и организации, участвующие в развитии водной инфраструктуры Узбекистана
        </p>
        <div className="relative max-w-md mx-auto">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-gray-900/50 border border-gray-700 rounded-lg focus:outline-none focus:border-primary"
          />
        </div>
      </div>
